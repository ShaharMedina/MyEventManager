<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="MyEventManager.Account.Register" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="BirthDate" CssClass="form-control-static" TextMode="DateTime" />
